...
<Note: The value should correspond to the username, ie: if its user1 then the value should be user1, if its user2 then the value should be user 2, etc> 
 MAY NEED TO FIX ABOVE UP
...
----
select * from %user%-db.fruit limit 5;
----
